...
export const HERO_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663502251693/FPcGgsvuUJ9d3gUJtCTgVQ/hero_overhead_dining_ai-HpXN5XKWxwcSbG9pey6NrZ.webp";  // AI-generated overhead fine-dining table — gold charger plates, white linen, crystal wine glasses, tall candles, white rose centerpiece, gourmet plated dishes (salmon, beef tenderloin, truffle pasta, edible flower salad), people's hands in elegant attire actively eating
