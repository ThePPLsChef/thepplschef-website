          ...
          {tiers.map((tier, i) => (
            ...
            >
              ...
              >
                {/* Most Popular Badge */}
                {tier.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-5 py-1.5 bg-[#D82E2B] text-white text-[10px] font-bold tracking-widest uppercase rounded-full shadow-[0_4px_12px_rgba(216,46,43,0.3)] whitespace-nowrap">
                    Most Popular
                  </div>
                )}
                ...
                <div className="p-10 lg:p-12 flex flex-col h-full">
                  ...
                  <Link
                    href={ctaHref}
                    className={`w-full py-4 font-bold tracking-wider uppercase transition-all duration-300 text-center block rounded-xl ${
                      tier.popular
