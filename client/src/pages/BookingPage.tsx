...
import { LOGO, HERO_BG } from "@/lib/images";
        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="space-y-8">
              <div>
                <img src={LOGO} alt="The PPL's Chef" className="h-16 w-16 rounded-full object-cover border-[3px] border-[#ECA241] shadow-xl mb-4" />
